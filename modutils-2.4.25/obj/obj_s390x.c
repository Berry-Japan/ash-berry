                      ...
                      Elf64_Addr v)
{
  ...
  switch (ELF64_R_TYPE(rel->r_info))
    ...
    case R_390_PLT32:
    case R_390_PLT16DBL:
      /* For PLT relocs, the addend applies to the PLT slot.  */
      v -= rel->r_addend;
